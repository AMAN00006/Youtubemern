...
const Video = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (!hasViewed) {
          await axios.put(`https://youtubemern.vercel.app/api/videos/view/${currentVideo._id}`);
          setHasViewed(true);
        }


        const videoRes = await axios.get(`https://youtubemern.vercel.app/api/videos/find/${path}`)
        const chanelRes = await axios.get(`https://youtubemern.vercel.app/api/users/find/${videoRes.data.userId}`);
  ...
  const handleLike = async () => {
    ...
    try {
      ...
      await axiosForLike.put(`https://youtubemern.vercel.app/api/users/like/${currentVideo._id}`)
  ...
  const handleDislike = async () => {
    ...
    try {
      ...
      await axiosForDislike.put(`https://youtubemern.vercel.app/api/users/dislike/${currentVideo._id}`)
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      currentUser.subscribedUsers?.includes(chanel._id)
        ...
        ? await axiosForSub.put(`https://youtubemern.vercel.app/api/users/unsub/${chanel._id}`)



        : await axiosForSub.put(`https://youtubemern.vercel.app/api/users/sub/${chanel._id}`);
